                ...
                <div className="col-md-6">
                    <div className="row m-5">
                        <div className="col-md-8 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                            <div>
                                <h3 className="text-center ">Ustoz</h3>
                                <form noValidate onSubmit={facultyFormHandler}>
                                    <div className="form-group">
                                        <label htmlFor="facRegId">Registratsiya raqami</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="passwordFacId">Parol</label>
                                ...
                                <p className="text-center mt-2 "><Link className="text-center" to="/forgotPassword/faculty">Parolni unutmoq...</Link></p>
                            </div>
                        </div>
                    </div>
                    <div className="row m-5">
                        <div className="col-md-8 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                            <div>
                                <h3 className="text-center">Talaba</h3>
                                <form noValidate onSubmit={studentFormHandler}>
                                    <div className="form-group">
                                        <label htmlFor="studentId">Registratsiya raqami</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="passwordId">Parol</label>
                                    ...
                                    {!isStudentLoading && <button type="submit" className="btn btn-info btn-block ">Kirish</button>}

                                </form>
                                <p className="text-center"><Link className="text-center" to="/forgotPassword/student">Parolni unutmoq</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
