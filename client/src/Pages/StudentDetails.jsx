                            ...
                            <div className="row mt-3">
                                <div className="col mb-2">
                                    <form className="form-inline" onSubmit={formHandler}>
                                        ...
                                        <button type="submit" className="btn btn-block btn-info mt-1 ">Izlash</button>
                                    </form>
                                </div>
                            </div>
                            <div className="row justify-content-center mt-4 mb-4 ">
                                <div className="col">
                                    <form noValidate onSubmit={formHandler}>
                                        <div className="form-group">
                                            <label htmlFor="branchId">Bo`lim</label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="yearId">Kursi</label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="sectionId">Korpus</label>
                                        ...
                                        <button type="submit" className="btn btn-info btn-block">Izlash</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col">
                                    <div className="row">
                                        <div className="col-md-6 border">
                                            <h4 className="text-center">Yangi chat</h4>
                                                ...
                                                <tbody>
                                                    {
                                                        store.student.newerChats.map((res, index) =>
                                                            <tr key={index}>
                                                                ...
                                                                <td><Link to={`/student/${res.senderRegistrationNumber}`}>Boshlash</Link></td>
                                                            </tr>
                                                        )
                                                    }
                                                </tbody>
                                        ...
                                        <div className="col-md-6 border">
                                            <h4 className="text-center">Eski Chat</h4>
                                            <table className="table">
                                                <tbody>
                                                    {
                                                        store.student.previousChats.map((res, index) =>
                                                            <tr key={index}>
                                                                ...
                                                                <td><Link to={`/student/${res.receiverRegistrationNumber}`}>Boshlash</Link></td>
                                                            </tr>
                                                        )
                                                    }
                                                </tbody>
                        ...
                        <div className="col-md-6 m-auto">
                            <table className="table">
                                <thead>
                                    <tr>
                                        <th scope="col">N#</th>
                                        <th scope="col">Registratsiya raqami</th>
                                ...
                                <tbody>
                                    {result.map((obj, index) =>
                                        <tr key={index}>
                                            ...
                                            <td>{obj.name}</td>
                                            <td><Link to={`/student/${obj.registrationNumber}`}>Boshlash</Link></td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
