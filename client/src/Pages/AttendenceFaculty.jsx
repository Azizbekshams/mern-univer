                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-4">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            {!isLoading && <button type="submit" className="btn btn-info  ">Qidirish</button>}
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-4">
                        <form onSubmit={secondFormHandler}>
                            <div className="form-group">
                                <label htmlFor="subjectId">Fan kodi</label>
                            ...
                            {!isLoading2 && <button type="submit" className="btn btn-info ml-1  ">Tasdiqlash</button>}
                        </form>
                    </div>
                </div>
                }</> : (history.push('/'))}
