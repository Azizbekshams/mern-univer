                            ...
                            <div className="d-flex justify-content-md-center vh-100">
                                <form noValidate onSubmit={formHandler}>
                                    <div className="form-group">
                                        <label htmlFor="snameId">Fan nomi</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="scodeId">Fan kodi</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="totalLectures">Umumiy dars</label>
                                    ...
                                    {!isLoading && <button type="submit" className="btn btn-info  ">Fan qo`shish</button>}
