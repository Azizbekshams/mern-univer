                    ...
                    {!helper ? <>
                        <form noValidate onSubmit={sendOTPHandler}>
                            <div className="form-group">
                                ...
                                <small id="emailHelp" className="form-text text-muted">5 minut vaqtingiz ketadi.</small>
                                {errors.email && (
                            ...
                            <form noValidate onSubmit={submitOTPHandler}>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail2">Yangi parol</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail3">Parolni yangilash</label>
