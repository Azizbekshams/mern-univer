                        ...
                        <div className="col-md-5 m-auto">
                            <form noValidate onSubmit={formHandler}>
                                <div className="form-group">
                                    <label htmlFor="emailId">Eski parol</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="passwordId">Yangi parol</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="passwordCId">Yangi parolni tasdiqlash</label>
                                ...
                                <button type="submit" class="btn btn-info btn-block ">Parolni yangilash</button>
                            </form>
                        </div>
                    </div>
                </div></> : (history.push('/'))}
